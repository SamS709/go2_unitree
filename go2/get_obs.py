...
def get_obs_lidar(
    ...
    height_map_copy[:,:] = torch.tensor([[0.25 for j in range(height_map_copy.shape[1])] for i in range(height_map_copy.shape[0])])
    ...
    # FILLING OBS VECTOR
    obs = torch.zeros(50 + height_map_copy.shape[0]**2)
